...
{{- define "eric-cloud-native-kvdb-rd-operand.aggregatedMerge" -}}
  {{- $merged := dict -}}
  {{- $context := .context -}}
  {{- $location := .location -}}
...
*/ -}}
{{- define "eric-cloud-native-kvdb-rd-operand.mergeAnnotations" -}}
  {{- include "eric-cloud-native-kvdb-rd-operand.aggregatedMerge" (dict "context" "annotations" "location" .location "sources" .sources) }}
{{- end -}}

{{- define "eric-cloud-native-kvdb-rd-operand.mergeLabels" -}}
  {{- include "eric-cloud-native-kvdb-rd-operand.aggregatedMerge" (dict "context" "labels" "location" .location "sources" .sources) }}
{{- end -}}
