...
@Slf4j
public class RedirectFromTerminateToRollback extends RedirectToAnotherOperation<RollbackOperation> {

    public RedirectFromTerminateToRollback(final RollbackOperation routeToOperation,
