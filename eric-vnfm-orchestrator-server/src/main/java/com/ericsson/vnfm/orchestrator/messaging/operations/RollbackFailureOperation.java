...
import static com.ericsson.vnfm.orchestrator.messaging.routing.RoutingUtility.ROLLBACK_FAILURE_PATTERN;
...
import com.ericsson.vnfm.orchestrator.presentation.services.lcm.operations.EvnfmManualRollback;
import com.ericsson.vnfm.orchestrator.repositories.DatabaseInteractionService;
import com.ericsson.workflow.orchestration.mgmt.model.messaging.HelmReleaseLifecycleMessage;

@Component
public class RollbackFailureOperation extends AbstractLifeCycleOperationProcessor {

    @Autowired
    private DatabaseInteractionService databaseInteractionService;

    @Autowired
    private EvnfmManualRollback rollbackOperation;
    ...
    public Conditions getConditions() {
        return new Conditions(ROLLBACK_FAILURE_PATTERN, HelmReleaseLifecycleMessage.class);
    }
    ...
    public MessageHandlingConfiguration<HelmReleaseLifecycleMessage> configureCompleted() {
        return new MessageHandlingConfiguration<HelmReleaseLifecycleMessage>()
                .startWith(new TriggerNextRollbackPatternStage(rollbackOperation))
