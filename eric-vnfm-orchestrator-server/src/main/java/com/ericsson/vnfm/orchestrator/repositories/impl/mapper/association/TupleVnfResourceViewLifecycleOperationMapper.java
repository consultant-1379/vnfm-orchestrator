...
public class TupleVnfResourceViewLifecycleOperationMapper implements TupleAssociationMapper<VnfResourceView, LifecycleOperation> {
    @Override
    public void map(final Tuple tuple,
        ...
        if (Objects.nonNull(operationOccurrenceId)) {
            ...
            vnfResourceView.setLastLifecycleOperation(lifecycleOperation);
        }
    }
}
