...
public class V64_2__UpdateDefaultClusterConfigFile extends BaseJavaMigration {
    ...
    private static void updateDefaultConfigFile(final JdbcTemplate jdbcTemplate) {
        ...
        if (clusterConfig != null) {
            ...
            in.addValue(CONFIG_FILE, defaultKubeConfig.get(KUBE_CONFIG_STRING));
            in.addValue(CLUSTER_SERVER, defaultKubeConfig.get(CLUSTER_SERVER));
