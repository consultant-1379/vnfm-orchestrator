...
public class AddNodePositiveBase extends AbstractDbSetupTest {
    @Inject
    ...
    public void setUp() throws JsonProcessingException {
        ...
        given(enmTopologyService.generateAddNodeScript(anyMap())).willReturn(path);
        doNothing().when(ossNodeService).addNode(any(), anyMap(), any());
        given(databaseInteractionService.saveVnfInstanceToDB(any())).willReturn(new VnfInstance());
