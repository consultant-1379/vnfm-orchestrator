...
public class GetConfigurationsNegativeBase extends ContractTestRunner {
    ...
    public void setUp() {
        ...
        given(kubernetesService.getPodNames()).willReturn(List.of("not-listed-kubernetes-pod-name-mock"));
