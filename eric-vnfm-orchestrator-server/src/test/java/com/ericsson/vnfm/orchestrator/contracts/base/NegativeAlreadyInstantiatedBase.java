...
public class NegativeAlreadyInstantiatedBase extends AbstractDbSetupTest {
    ...
    public void setUp() throws IOException {
        ...
        value.setVnfInstanceId("already-instantiated");
        given(lifeCycleManagementService.executeRequest(any(), anyString(), any(), anyString(), anyMap()))
                .willThrow(new AlreadyInstantiatedException(value));
