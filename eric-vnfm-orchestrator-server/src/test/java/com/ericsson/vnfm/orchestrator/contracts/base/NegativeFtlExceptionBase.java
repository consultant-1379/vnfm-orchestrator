...
public class NegativeFtlExceptionBase extends AbstractDbSetupTest {
    ...
    public void setup() throws JsonProcessingException {
        ...
        doThrow(new FileExecutionException("Failed to add node with following parameters"))
                .when(ossNodeService).addNode(any(), anyMap(), any());
        doThrow(new FileExecutionException("Failed to deleteFile node with following parameters"))
