...
public class NegativePreviousOperationNotInstantiateOrTerminateBase {
    ...
    public void setUp() {
        ...
        given(lifeCycleManagementService.cleanup(any(), any(), anyString())).willThrow(new LastOperationException(
                "Resources will not be cleaned up; last operation on instance was not a failed INSTANTIATE or TERMINATE"));
    ...
    private VnfInstance buildVnfInstance() {
        ...
        instance.setVnfInstanceId("LAST_OP_NOT_INSTANTIATE_OR_TERMINATE");
