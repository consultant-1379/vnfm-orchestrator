...
public class NegativeReleaseExistedBase {
    ...
    public void setUp() {
        ...
        given(lifeCycleManagementService.cleanup(any(), any(), anyString())).willThrow(new ReleaseNameInUseException(
                "Resources will not be cleaned up; instantiate failed because another release with the same name already existed"));
    ...
    private VnfInstance buildVnfInstance() {
        ...
        instance.setVnfInstanceId("release-already-existed");
