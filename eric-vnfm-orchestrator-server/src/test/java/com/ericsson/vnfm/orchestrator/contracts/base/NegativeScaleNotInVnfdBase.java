...
public class NegativeScaleNotInVnfdBase extends AbstractDbSetupTest {
    ...
    public void setUp() {
        ...
        vnfInstance.setVnfInstanceId("NO_SCALE_INTERFACE");
        given(lifeCycleManagementService.executeRequest(any(), anyString(), any(ScaleVnfRequest.class), anyString(), anyMap()))
                .willThrow(new IllegalOperationException("Vnfd does not contain interface scale"));
    }
}
