...
Contract.make {
    description("""
Represents an error scenario of getting all backup scopes

```
given:
  client requests to get all backup scopes
when:
...
""")
    request {
        method GET()
        urlPath($(regex("/vnflcm/v1/vnf_instances/wf1ce-rd45-477c-vnf0-backup001/backup/scopes")))
        headers {
