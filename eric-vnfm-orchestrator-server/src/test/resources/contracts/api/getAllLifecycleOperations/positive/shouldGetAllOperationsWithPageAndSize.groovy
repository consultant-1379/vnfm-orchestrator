...
```
given:
  client requests to view all operations with pagination information for page 2 and size 5
when:
...
""")
    ...
    response {
        ...
        body(file('allLifecycleOperationsWithPageAndSize.json'))
        bodyMatchers {
            ...
            jsonPath('$.items.[*].vnfInstanceName', byCommand("assertThat(parsedJson.read(\"\$.items[*].vnfInstanceName\", Object.class)).isNotNull()"))
