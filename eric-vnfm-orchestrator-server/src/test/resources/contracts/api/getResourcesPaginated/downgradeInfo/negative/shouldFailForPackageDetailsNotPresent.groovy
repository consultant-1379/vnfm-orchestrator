...
""")
    request {
        method 'GET'
        url "/api/v1/resources/${value(consumer('package-details-deleted-for-downgrade'), producer('package-details-deleted-for-downgrade'))}/downgradeInfo"
    }
    response {
                ...
                """
                       {
                          ...
                          "status":412,
                          "detail":"Downgrade not supported for instance id package-details-deleted-for-downgrade as the target downgrade package is no longer available",
