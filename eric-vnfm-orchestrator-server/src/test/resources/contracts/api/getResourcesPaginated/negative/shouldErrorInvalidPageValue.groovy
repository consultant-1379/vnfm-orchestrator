...
Contract.make {
    description("""
Represents a failure scenario for wrong formed request when getting vnf resources with pagination

```
given:
  client requests vnf resources with an invalid page number
when:
