...
Contract.make {
    description("""
Represents a failed scenario of creating a local backup for a VNF Instance when VNFD host is not defined 
...
""")
    request {
        method 'POST'
        urlPath($(regex("/vnflcm/v1/vnf_instances/wf1ce-rd45-477c-vnf0-backup001" +
                "/backups")))
        headers {
