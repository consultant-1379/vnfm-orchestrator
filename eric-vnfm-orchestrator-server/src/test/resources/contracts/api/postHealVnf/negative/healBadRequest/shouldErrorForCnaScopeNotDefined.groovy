...
when:
  a request with only restore.backupName as additional params is submitted
then:
...
""")
    request {
        method 'POST'
        urlPath($(regex("/vnflcm/v1/vnf_instances/[a-z0-9]+(-[a-z0-9]+)*BAD_REQUEST_CNA_SCOPE/heal")))
        headers {
                ...
                """
                       {
                          ...
                          "status":400,
                          "detail":"Invalid CNA Restore request. restore.scope is not present or an invalid value.",
