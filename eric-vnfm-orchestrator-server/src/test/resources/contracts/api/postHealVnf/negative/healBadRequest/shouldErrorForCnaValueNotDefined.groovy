...
when:
  a request without day0.configuration.param1.value is submitted
then:
...
""")
    request {
        method 'POST'
        urlPath($(regex("/vnflcm/v1/vnf_instances/[a-z0-9]+(-[a-z0-9]+)*BAD_REQUEST_CNA_NO_REQUIRED_KEY/heal")))
        headers {
                ...
                """
                    {
                       ...
                       "status":400,
                       "detail":"Invalid Day0 configuration. At least one key-value pair is needed.",
