...
Contract.make {
    description("""
Represents a successful scenario of Instantiating a VNF Instance with Cluster Name and extensions

```
given:
  client requests to instantiate a VNF instance with Cluster Name and Extensions
when:
