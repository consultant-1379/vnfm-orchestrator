...
Contract.make {
    description("""
Represents a successful scenario of Instantiating a VNF Instance with escaped additional attributes

```
given:
  client requests to instantiate a VNF instance with escaped additional parameters
when:
...
""")
    request {
        ...
        body(
                file('escaped-additional-parameters.json'),
        )
        bodyMatchers {
