...
Contract.make {
    description("""
Represents a successful scenario of Instantiating a VNF Instance with Instantiation Level Id

```
given:
  client requests to instantiate a VNF instance with Instantiation Level Id
when:
