...
Contract.make {
    description("""
Represents a successful scenario of Instantiating a VNF Instance with Instantiation Level Id, some Addtional Parameters and Cluster Name

```
given:
  client requests to instantiate a VNF instance with Instantiation Level Id, some Additional Parameters and Cluster Name
when:
...
""")
    request {
        ...
        bodyMatchers {
            ...
            jsonPath('$.clusterName', byRegex('[0-9a-zA-Z][0-9a-zA-Z-_]*(\\.config)?'))
