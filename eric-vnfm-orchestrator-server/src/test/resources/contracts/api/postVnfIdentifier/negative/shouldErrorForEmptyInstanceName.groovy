...
when:
  a request with empty vnfInstanceName is submitted
then:
...
""")
    request {
        ...
        bodyMatchers {
            ...
            jsonPath('$.vnfInstanceName', byRegex(/^$/))
                ...
                """
                        {
                            ...
                            "title": "Bad Request",
                            "status": 400,
                            "detail": "vnfInstanceName size must be between 1 and 2147483647, vnfInstanceName must consist of lower case alphanumeric characters, - or ., and must start and end with an alphanumeric character",
