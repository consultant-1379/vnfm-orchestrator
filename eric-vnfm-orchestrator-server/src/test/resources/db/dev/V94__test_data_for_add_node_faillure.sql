...
current_life_cycle_operation_id, namespace, oss_topology, add_node_oss_topology, added_to_oss, clean_up_resources)
VALUES ('srgtgdbsgsrg-aab3-21c454e43af', 'vnf-test-failure-add-node', 'vnfInstanceDescription',
'e3def1ce-4cf4-477c-aab3-21c454e6a389', 'Ericsson', 'SGSN-MME',
 ...
 "networkElementPassword":{"type":"string","required":"false","default":"password"}}', 'false', 'true'
 );
...
error)
VALUES ('fgdrsgfnb673-91ee-761fd83641e6', 'srgtgdbsgsrg-aab3-21c454e43af', 'PROCESSING', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP, null,
'INSTANTIATE', 'FALSE', '{"instantiationLevelId":"123","additionalParams":{"cleanUpResources":true,"addNodeToOSS": true,"applicationTimeOut":"500",
"commandTimeOut":"500"}}', 'FALSE',
'FORCEFUL',
null);